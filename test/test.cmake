...
Python_add_library(lak MODULE USE_SABI 3.123 #[[comment]] file1 file2 file3)

if(UNIX AND NOT APPLE AND NOT ANDROID AND NOT HAIKU)
    set(MY_VAR ON)
endif()

if(UNIX AND NOT APPLE AND NOT ANDROID AND NOT HAIKU AND ${SOME_LONG_VAR} AND ${ANOTHER_LONG_LONG_VAR} AND ${ANOTHER_LONG})
    set(MY_VAR ON)
endif()
...
install(FILES "${CMAKE_CURRENT_BINARY_DIR}/LongLongFileAbc.cmake"
